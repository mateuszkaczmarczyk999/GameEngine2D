...
void Registry::AddComponent(Entity entity, TArgs &&... args) {
    ...
    Logger::Log(
        "Component Id: " + std::to_string(componentId) + " was added to Entity with id: " + std::to_string(entityId));
};
...
void Registry::RemoveComponent(Entity entity) {
    ...
    Logger::Log(
        "Component Id: " + std::to_string(componentId) + " was removed from Entity with id: " +
